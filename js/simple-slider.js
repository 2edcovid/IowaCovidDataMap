  ...
  function o(t, o) {
    ...
    function H(a) {
      (q = a.selection ? a.selection() : a),
        o ||
          (o = (o = m[0] instanceof Date ? i.scaleTime() : i.scaleLinear())
            .domain(m)
            .range(1 === t || 3 === t ? [0, h] : [g, 0])
            .clamp(!0)),
      ...
      l
        ...
        D &&
          l
            ...
            .attr(O + "1", 1 === d.length ? o.range()[0] - 8 * V : o(d[0]))
            .attr("stroke", D)
            .attr("stroke-width", 4)
            .attr("stroke-linecap", "round"),
        l
      ...
      s
        ...
        .on("keydown", function (t, e) {
          ...
          switch (u.event.key) {
            case "ArrowLeft":
            case "ArrowDown":
              H.value(r(+d[e] - a)), u.event.preventDefault();
              break;
            case "PageDown":
              H.value(r(+d[e] - 2 * a)), u.event.preventDefault();
              break;
            case "ArrowRight":
            case "ArrowUp":
              H.value(r(+d[e] + a)), u.event.preventDefault();
        ...
        p &&
          s
            ...
            .attr("transform", d.length > 1 ? "translate(0,0)" : null)
            .text(function (t, e) {
              return A(d[e]);
            }),
        ...
        D &&
          a
            .select(".track-fill")
            .attr(O + "2", 1 === d.length ? o(d[0]) : o(d[1])),
    ...
    function _(t, e) {
      (d[0] !== t[0] || (d.length > 1 && d[1] !== t[1])) &&
        ((d = t), e && M.call("onchange", H, 1 === t.length ? t[0] : t), Q());
    }
    function C(t, e) {
      q &&
        ((e = void 0 !== e && e)
          ? (q
            ...
            D &&
              T.transition()
                .ease(l.easeQuadOut)
                .duration(200)
                .attr(O + "1", 1 === d.length ? o.range()[0] - 8 * L : o(t[0]))
                .attr(O + "2", 1 === d.length ? o(t[0]) : o(t[1])))
          : (q
              .selectAll(".parameter-value")
              .data(t)
              .attr("transform", function (t) {
            ...
            D &&
              T.attr(
                O + "1",
                1 === d.length ? o.range()[0] - 8 * L : o(t[0])
              ).attr(O + "2", 1 === d.length ? o(t[0]) : o(t[1]))),
        p &&
          j.text(function (e, a) {
            return b(t[a]);
    ...
    return (
      o &&
        ...
        1 === t || 3 === t
          ...
          : (g = e.max(o.range()) - e.min(o.range())),
        (o = o.clamp(!0))),
      (H.min = function (t) {
        return arguments.length ? ((m[0] = t), o && o.domain(m), H) : m[0];
      }),
      (H.max = function (t) {
        return arguments.length ? ((m[1] = t), o && o.domain(m), H) : m[1];
      }),
      (H.domain = function (t) {
        return arguments.length ? ((m = t), o && o.domain(m), H) : m;
      }),
      (H.width = function (t) {
        return arguments.length
          ? ((h = t), o && o.range([o.range()[0], o.range()[0] + h]), H)
          : h;
      }),
      (H.height = function (t) {
        return arguments.length
          ? ((g = t), o && o.range([o.range()[0], o.range()[0] + g]), H)
          : g;
      }),
