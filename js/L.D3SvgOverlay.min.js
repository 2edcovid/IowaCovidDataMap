...
(function(L,d3) {
    ...
    L.D3SvgOverlay=(L.version<"1.0"?L.Class:L.Layer).extend( {
        ...
        onAdd:function(map) {
            ...
            this._zoom=this.map.getZoom();this._shift=L.point(0,0)
            this._scale=1;
            this.projection={
                latLngToLayerPoint:function(latLng,zoom) {
                    zoom=_layer._undef(zoom)?_layer._zoom:zoom;var projectedPoint=_layer.map.project(L.latLng(latLng),zoom)._round();
                ...
                map:_layer.map,layer:_layer,scale:1
            };
            this.projection._projectPoint=function(x,y) {
                var point=_layer.projection.latLngToLayerPoint(new L.LatLng(y,x));
                this.stream.point(point.x,point.y)
            };
            this.projection.pathFromGeojson=d3.geo.path().projection(d3.geo.transform({
